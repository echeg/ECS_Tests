...
class System99 : IEcsInitSystem, IEcsRunSystem{
 ...
 public void Run (EcsSystems systems) {
  ...
  var q = 0;
   ...
   if (_world.GetPool<Component363>().Has(entity))
   {
    q+=1;
    var component1 = _world.GetPool<Component363>().Get(entity);
   }
   else
   {
    q-=1;
   ...
   if (_world.GetPool<Component361>().Has(entity))
   {
    q+=1;
    var component1 = _world.GetPool<Component361>().Get(entity);
   }
   else
   {
    q-=1;
