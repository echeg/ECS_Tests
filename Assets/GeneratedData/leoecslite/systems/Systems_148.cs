...
EcsPool<Component336> _p2;
EcsPool<Component367> _p3;
EcsPool<Component81> _pl0;
 public void Init (EcsSystems systems) {
  _world = systems.GetWorld ();
  _filter = _world.Filter<Component102>().Inc<Component336>().Inc<Component367>().End();
   _p1 = _world.GetPool<Component102>();
   _p2 = _world.GetPool<Component336>();
   _p3 = _world.GetPool<Component367>();
   _pl0 = _world.GetPool<Component81>();
 }
