...
EcsPool<Component413> _pl1;
EcsPool<Component372> _pl2;
EcsPool<Component442> _pl3;
 public void Init (EcsSystems systems) {
  ...
  _filter = _world.Filter<Component440>().Inc<Component244>().End();
   ...
   _pl1 = _world.GetPool<Component413>();
   _pl2 = _world.GetPool<Component372>();
   _pl3 = _world.GetPool<Component442>();
 }
