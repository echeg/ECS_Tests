...
EcsPool<Component46> _pl1;
EcsPool<Component340> _pl2;
EcsPool<Component398> _pl3;
 public void Init (EcsSystems systems) {
  ...
  _filter = _world.Filter<Component422>().Inc<Component444>().Inc<Component361>().End();
   ...
   _pl1 = _world.GetPool<Component46>();
   _pl2 = _world.GetPool<Component340>();
   _pl3 = _world.GetPool<Component398>();
 }
