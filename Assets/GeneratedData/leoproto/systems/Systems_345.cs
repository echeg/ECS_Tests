...
class System345 : IProtoInitSystem, IProtoRunSystem{
 ...
 _it = new ProtoIt (new [] {typeof(Component28),typeof(Component290),typeof(Component223),typeof(Component35) } );
  _it.Init (_world);
 }
 public void Run () {
  ...
  var q = 0;
   ...
   if (_aspect.Component371Pool.Has(_it.Entity()))
   {
    q+=1;
    var component1 = _aspect.Component371Pool.Get(_it.Entity());
   }
   else
   {
    q-=1;
