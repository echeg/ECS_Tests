...
class System204 : IProtoInitSystem, IProtoRunSystem{
 ...
 _it = new ProtoIt (new [] {typeof(Component232),typeof(Component277),typeof(Component495) } );
  _it.Init (_world);
 }
 public void Run () {
  ...
  var q = 0;
   ...
   if (_aspect.Component22Pool.Has(_it.Entity()))
   {
    q+=1;
    var component1 = _aspect.Component22Pool.Get(_it.Entity());
   }
   else
   {
    q-=1;
