...
class System231 : IProtoInitSystem, IProtoRunSystem{
 ...
 _it = new ProtoIt (new [] {typeof(Component390),typeof(Component175),typeof(Component137),typeof(Component114) } );
  _it.Init (_world);
 }
 public void Run () {
  ...
  var q = 0;
   ...
   {
    q+=1;
    var component1 = _aspect.Component194Pool.Get(_it.Entity());
   }
   else
   {
    q-=1;
