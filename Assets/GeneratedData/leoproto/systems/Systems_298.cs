...
class System298 : IProtoInitSystem, IProtoRunSystem{
 ...
 _it = new ProtoIt (new [] {typeof(Component109) } );
  _it.Init (_world);
 }
 public void Run () {
  for (_it.Begin (); _it.Next ();) {
  var q = 0;
   if (_aspect.Component161Pool.Has(_it.Entity()))
   {
    q+=1;
    var component1 = _aspect.Component161Pool.Get(_it.Entity());
   }
   else
   {
    q-=1;
